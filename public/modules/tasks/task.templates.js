...
export function getAIAssistantReviewViewHTML(plan, taskTitleMap) {
    ...
    return `
        <div class="ai-plan-review" data-plan-container="true">
            <div class="flex justify-between items-center p-4 border-b border-slate-200 dark:border-slate-700">
                <h3 class="text-xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-3">
            ...
            <div class="p-4 bg-white/70 dark:bg-slate-800/70 border-t border-slate-200 dark:border-slate-700 backdrop-blur-sm flex justify-end items-center gap-3">
                <button id="ai-reject-plan-btn" type="button" data-action="reject-ai-plan" class="bg-slate-200 text-slate-800 px-4 py-2 rounded-md hover:bg-slate-300 font-semibold transition-colors">Volver a Editar</button>
                <button id="ai-confirm-plan-btn" type="submit" form="ai-execution-plan-form" data-action="confirm-ai-plan" class="bg-purple-600 text-white px-5 py-2 rounded-md hover:bg-purple-700 font-semibold transition-colors flex items-center gap-2">
                ...
                <div class="task-form-section">
                    ...
                    <div class="p-4 grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                        ...
                        <div class="input-group md:col-span-3">
                            <label for="task-is-project-task" class="flex items-center gap-3 cursor-pointer text-sm font-medium text-slate-700">
                                <input type="checkbox" id="task-is-project-task" name="isProjectTask" class="h-4 w-4 rounded text-blue-600 focus:ring-blue-500 border-gray-300" ${isEditing && task.isProjectTask ? 'checked' : ''}>
                                <span>Mostrar en el planning</span>
                            </label>
                        </div>
                        <div class="input-group md:col-span-3">
                            <label for="task-progress" class="flex justify-between items-center">
                                <span>Progreso</span>
                                <span id="task-progress-value" class="font-bold text-slate-600">${isEditing && task.progress ? task.progress : '0'}%</span>
                            </label>
